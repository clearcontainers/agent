...
# Return Clear Containers symlink to latest installed
latest_image=$(ls /usr/share/clear-containers/clear-*-containers.img | sort -n | tail -1)
sudo ln -sf "${latest_image}" "${cc_image_path}"
