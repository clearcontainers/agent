# Contributing to the Clear Containers VM agent

The Clear Containers agent is an open source project licensed under the
...
We accept [github pull requests](https://github.com/clearcontainers/agent/pulls).
...
The Clear Containers agent maintainers will be the ones accepting or rejecting any pull request. They are listed in the OWNERS files, and there can be one OWNERS file per directory.
...
github](https://github.com/clearcontainers/agent/issues/new) so we all get
